...
state_df <- merge(state_df[,c("year", "state_fips_code", "state_name", "Value")],
                  state_df_soy[,c("year", "state_fips_code", "AcresPlanted_Soy")],
...
rm(USDA, states, Sales_Monthly_Corn, Sales_Monthly_Soy, Sales_Running_Corn, Sales_Running_Soy,
   zone, zoneTranslator)
